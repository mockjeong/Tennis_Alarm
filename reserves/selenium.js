...
async function sajickCheck(targetMonth, targetDay){
  ...
  try {
    ...
    var dateSelectXpath = `//label[contains(text(),'${targetMonth}월 ${targetDay}일')]`
    let dateSelectElement = await driver.wait(until.elementLocated(By.xpath(dateSelectXpath)), 10000);
